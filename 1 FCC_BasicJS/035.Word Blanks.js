...
//คำสั่ง
/*n this challenge, we provide you with a noun, a verb, an adjective and an adverb. 
...
You will then assign the formed string to the wordBlanks variable. You should not
 change the words assigned to the variables.
